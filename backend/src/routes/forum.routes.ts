...
// ── Moderación (MODERATOR / ADMIN) ────────────────────────────────
/**
 * @swagger
 * /forum/reports:
 *   get:
 *     summary: Listar reportes (MODERATOR/ADMIN)
 *     tags: [Foro]
 *     security: [{ bearerAuth: [] }]
 *     responses:
 ...
 *   put:
 *     summary: Aprobar reporte → soft-delete + penalizar (MODERATOR/ADMIN)
 *     tags: [Foro]
 *     security: [{ bearerAuth: [] }]
 *     responses:
 ...
 *   put:
 *     summary: Rechazar reporte → restaurar (MODERATOR/ADMIN)
 *     tags: [Foro]
 *     security: [{ bearerAuth: [] }]
 *     responses:
 ...
 * /forum/admin/stats:
 *   get:
 *     summary: Estadísticas generales del foro (ADMIN/MODERATOR)
 *     tags: [Foro]
 *     security: [{ bearerAuth: [] }]
 *     responses:
